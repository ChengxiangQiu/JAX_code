...
major_trajectory_color_plate = c("Brain_and_spinal_cord"     = "#f96100",
...
posterior_embryo_color_plate = c("Notochord"                      = "#1F77B4",
                                 "Nodal cilia"                    = "#FF7F0E", 
                                 "Neuromesodermal progenitors"    = "#2CA02C",
                                 "Gut"                            = "#D62728",
...
LPM_color_plate = c("Splanchnic mesoderm"                   = "#ca47cc",
                    ...
                    "Cardiopharyngeal mesoderm (Tbx1+)"     = "#3f2b71",

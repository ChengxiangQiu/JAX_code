...
celltype_include = ["CNS_neurons", "Ependymal_cells", "Intermediate_neuronal_progenitors", 
                    "Neuroectoderm_and_glia", "Oligodendrocytes"]

celltype_list_exclude = ["Amacrine cells", "Amacrine/Horizontal precursor cells", "Cholinergic amacrine cells", "Horizontal cells", "PV-containing retinal ganglion cells", "Retinal ganglion cells", "Ciliated nodal cells"]

day_include = ["E8.5", "E8.75", "E9.0", "E9.25", "E9.5", "E9.75", "E10.0", "E10.25", 
               "E10.5", "E10.75", "E11.0", "E11.25", "E11.5", "E11.75", "E12.0", 
               "E12.25", "E12.5", "E12.75"]

example_id = "Neuroectoderm_derivative"
print(example_id)

adata = adata[adata.obs["major_trajectory"].isin(celltype_include)]

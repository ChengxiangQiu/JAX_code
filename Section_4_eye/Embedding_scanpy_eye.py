...
day_list = ["E8.5", "E8.75", "E9.0", "E9.25", "E9.5", "E9.75", "E10.0", "E10.25", "E10.5", "E10.75", "E11.0", "E11.25", "E11.5", "E11.75", "E12.0", "E12.25", "E12.5"]

example_id = "Eye_plus2_early"
print(example_id)
...
adata = adata[adata.obs["day"].isin(day_list)]
...
adata = sc.read_mtx(os.path.join(WORK_PATH, 'example', '%s_gene_count.mtx'%example_id))
fdata = pd.read_csv("/net/shendure/vol2/projects/cxqiu/work/jax/rna_seq/mtx/df_gene.csv", index_col = 0)
pdata = pd.read_csv(os.path.join(WORK_PATH, 'example', '%s_df_cell.csv'%example_id), index_col = 0)
adata.obs = pdata
adata.var = fdata

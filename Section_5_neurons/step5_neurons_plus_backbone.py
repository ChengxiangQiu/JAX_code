...
trajectory_list = ["CNS_neurons", "Brain_and_spinal_cord", "Intermediate_progenitors", "Oligodendrocytes", "Ependymal_cells"]

celltype_list = ["Anterior floor plate", "Diencephalon", "Hypothalamus", "Mesencephalon", "Posterior floor plate", "Telencephalon", "Anterior roof plate", "Dorsal telencephalon", "Hindbrain", "Hypothalamus (Sim1+)", "Midbrain-hindbrain boundary", "Posterior roof plate", "Spinal cord/r7/r8"]

day_list = ["E85","E9","E95","E10","E11","E12"]

celltype_list_exclude = ["Amacrine cells", "Amacrine/Horizontal precursor cells", "Cholinergic amacrine cells", "Horizontal cells", "PV-containing retinal ganglion cells", "Retinal ganglion cells", "Nodal cilia"]

example_id = "Neurons_plus_big_backbone"
print(example_id)
...
adata.obs = pdata
adata = adata[adata.obs["celltype_update"].isin(celltype_list)]

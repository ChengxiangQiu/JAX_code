...
p = pd_x %>%
    ...
    ggsave(paste0(work_path, "Gut_celltype.png"), width = 4, height = 3, dpi = 300)
...
p = pd_x %>%
    ...
    theme(legend.position="none") + 
    ggsave(paste0(work_path, "Gut_day.png"), width = 4, height = 3, dpi = 300)
...
saveWidget(fig, paste0(work_path, example_i, "_Gut_PCA_celltype_update.html"), selfcontained = FALSE, libdir = "tmp")
